...
- Pendiente: secrets + deploy de las 11 functions, webhook de Stripe nuevo (el `whsec_` committeado está obsoleto), variables en Netlify/Render — detalle en "Estado actual" de CLAUDE.md y pasos 4-7 de RESTORE.md.
